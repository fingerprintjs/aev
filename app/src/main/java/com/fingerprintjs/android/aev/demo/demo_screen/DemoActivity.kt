...
import com.fingerprintjs.android.aev.demo.ActionMenuActivity
import com.fingerprintjs.android.aev.demo.R
import com.fingerprintjs.android.aev.demo.demo_screen.api.AevClientBuilder
import com.fingerprintjs.android.aev.demo.dialogs.LogsDialogView
...
class DemoActivity : ActionMenuActivity(), DemoRouter {
    ...
    private fun init() {
        presenter =
            DemoPresenterImpl(
                AevClientBuilder(this.applicationContext),
